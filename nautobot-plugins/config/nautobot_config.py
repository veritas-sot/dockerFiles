...
#
ALLOWED_HOSTS = os.getenv("NAUTOBOT_ALLOWED_HOSTS", "127.0.0.1").split(" ")
...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("NAUTOBOT_DB_USER", "admin"),  # Database username
        "PASSWORD": os.getenv("NAUTOBOT_DB_PASSWORD", "admin"),  # Database password
...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "w2s3xgl$*f*32p1)pwxxjytfwc@5jom+)wi!1-%8hnbnob3%1r")
